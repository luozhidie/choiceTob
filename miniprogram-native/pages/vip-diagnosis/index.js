Page({
  ...
  /* ── Q18 照片说明 ── */
  onPhotoNote: function (e) {
    this.setData({ photoNote: e.detail.value });
  },
  ...
  submit: function () {
    ...
    // 获取 openid（用于后端关联用户）
    var openidPromise = getApp().getOpenid ? getApp().getOpenid() : Promise.resolve(wx.getStorageSync("wx_openid") || "");
