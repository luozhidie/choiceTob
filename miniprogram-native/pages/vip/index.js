Page({
  data: {
    ...
    expireDate: '',
    pricePlans: [
      { id:'price_trial', name:'价格会员·体验', priceLabel:'¥19.9', originalPrice:'', discountLabel:'14天体验', features:['查看所有商品批发价','对比供货价与市场价差','爆款趋势预览'], highlight:false },
      { id:'price_3m', name:'价格会员·季卡', priceLabel:'¥128/季', originalPrice:'¥199', discountLabel:'省¥71', features:['查看所有商品批发价','对比供货价与市场价差','爆款趋势预测数据','行业选品报告(月)'], highlight:false },
      { id:'price_1y', name:'价格会员·年卡', priceLabel:'¥399/年', originalPrice:'¥798', discountLabel:'省¥399', features:['查看所有商品批发价','对比供货价与市场价差','爆款趋势预测数据','行业选品报告(月)','每日搭配订阅','专属客服通道'], highlight:true },
    ],
    depositPlans: [
  ...
  selectPlan:function(e){var plan=e.currentTarget.dataset.plan;this.setData({selectedPlan:plan,showPay:true});},
