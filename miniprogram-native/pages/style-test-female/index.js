...
var RESULTS = {
  少女型: {
    emoji: '🎀',
    star: '赵丽颖',
    image: BASE + '/style-test/female/shaonv.jpg',
  ...
  优雅型: {
    emoji: '💐',
    star: '刘嘉玲',
    image: BASE + '/style-test/female/youya.png',
  ...
  浪漫型: {
    emoji: '🌹',
    star: '钟楚红',
    image: BASE + '/style-test/female/langman.jpg',
  ...
  少年型: {
    emoji: '🧢',
    star: '李宇春',
    image: BASE + '/style-test/female/shaonian.jpg',
  ...
  时尚型: {
    emoji: '✨',
    star: '王菲',
    image: BASE + '/style-test/female/shishang.jpg',
  ...
  古典型: {
    emoji: '💼',
    star: '张曼玉',
    image: BASE + '/style-test/female/gudian.jpg',
  ...
  自然型: {
    emoji: '🌿',
    star: '王祖贤',
    image: BASE + '/style-test/female/ziran.jpg',
  ...
  戏剧型: {
    emoji: '👑',
    star: '梅艳芳',
    image: BASE + '/style-test/female/xiju.jpg',
