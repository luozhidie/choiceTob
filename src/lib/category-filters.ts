    ...
    quickFilters: [
      ...
      { key: "bulk_price", label: "批量采购价", type: "toggle" },
      {
        ...
        options: [
          ...
          "1码", "2码", "3码", "4码", "5码", "6码",
          "1即S", "2即M", "3即L", "4即XL", "5即XXL", "6即XXXL",
          "2XL", "f", "3XL", "4XL", "4xL", "5即2XL",
          "1即S码", "2即M码", "3即L码", "4即XL码", "5即2XL码", "6即3XL码",
          "36即S码", "38即M码", "40即L码", "42即XL码",
          "10即XL", "12即XXL",
          "4即S码", "6即M码", "8即L码",
          "1码即SM", "2码即LXL",
          "F1即S", "F2即M", "F3即L",
          // 套装专属：上下装分码组合
          "上衣均码裤子S", "上衣均码裤子M", "上衣均码裤子L",
          "上衣均码裙子S码", "上衣均码裙子M码", "上衣均码裙子L码",
          "上衣S+裤子S", "上衣M+裤子M", "上衣L+裤子L",
          "上衣S+裤子M", "上衣M+裤子L", "上衣L+裤子M",
          "上衣均码+短裤S", "上衣均码+短裤M", "上衣均码+短裤L",
          "上衣M半身裙均码", "上衣L半身裙均码", "上衣S半身裙均码",
          "上衣M半身裙S", "上衣M半身裙M", "上衣L半身裙S", "上衣L半身裙M"
        ],
      },
      {
        key: "fabrics",
        ...
        type: "popup",
        options: [
          "雪纺", "真丝", "醋酸", "缎面", "欧根纱", "蕾丝", "网纱",
          "西装料", "呢料", "毛料", "混纺", "针织", "梭织",
          "棉", "麻", "丝", "毛", "聚酯纤维", "氨纶", "锦纶", "涤纶", "涤棉",
          "丝光棉", "天丝", "莫代尔", "莱赛尔", "天丝棉", "天丝麻",
          "棉麻", "棉纶", "粘胶", "腈纶", "粘纤",
          "桑蚕丝", "山羊绒", "羊驼毛", "绵羊毛", "马海毛",
          "珠光丝", "亮丝", "金属丝", "镂空针织",
          "水溶料", "和纸", "竹节棉麻", "麻感棉", "螺纹棉", "段缩丝",
          "仿亚麻针织", "仿羊毛", "仿醋酸",
          "再生纤维", "冰丝棉", "冰麻", "包芯纱",
          "防晒面料", "衬衣料", "亮丝", "人丝", "人棉", "人棉锦纶",
          "牛奶棉", "精梳棉", "长绒棉", "高弹锦纶", "高捻棉",
          "提花布", "水洗棉", "洗水棉", "牛仔", "牛仔棉"
        ],
      },
    ],
    subCategories: ["两件套", "三件套", "裙套装", "裤套装", "背带套装", "运动套装", "家居套装", "衬衫套装"],
    filterPanel: {
      sections: [
        { title: "近期上新", key: "recent", options: ["今日上新", "近3日上新", "近7日上新"] },
        { title: "热卖活动", key: "hot_activity", options: ["7日爆款", "档口爆款", "今日特价", "限量补贴"] },
        ...
        { title: "色系", key: "color_family", multiple: true, options: ["花色系", "其他", "白色系", "黑色系", "灰色系", "红色系", "橙色系", "黄色系", "绿色系", "蓝色系", "紫色系", "棕色系", "金属色系", "拼色"] },
        { title: "季节", key: "season", multiple: true, options: ["春", "夏", "秋", "冬"] },
        { title: "套件数", key: "套件数", options: ["两件套", "三件套", "多件套"] },
        { title: "风格", key: "风格", multiple: true, options: ["休闲", "通勤", "运动", "家居", "甜美", "优雅", "街头", "度假", "学院", "OL"] },
        { title: "版型", key: "版型", options: ["修身", "宽松", "直筒", "A字", "Oversize", "H型"] },
        { title: "袖长", key: "袖长", options: ["无袖", "短袖", "五分袖", "七分袖", "长袖"] },
        { title: "领型", key: "领型", options: ["圆领", "V领", "翻领", "高领", "立领", "方领", "一字领", "娃娃领"] },
        { title: "图案", key: "图案", multiple: true, options: ["卡通", "条纹", "纯色", "字母", "动物纹", "波点", "拼色", "格纹", "佩斯利纹", "植物", "扎染", "图案", "线条", "碎花", "爱心", "标语", "星空", "花朵", "民族风图案"] },
        { title: "工艺", key: "工艺", multiple: true, options: ["无", "烫钻", "钉珠/片", "印花", "口袋", "印染", "毛边", "提花", "水洗", "打揽", "撞色线迹", "木耳边", "抽褶", "磨损破洞", "绗缝", "打结", "系带", "蕾丝拼接", "粗针(粗线)", "细针(细线)", "贴花/章", "镂空", "绣花", "压褶", "亮丝", "拼接/补丁", "编织/织带", "花边", "抽绳", "假两件"] },
      ],
    },
