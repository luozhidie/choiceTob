                    ...
                    {payMethod === "wechat" ? (
                      <>
                        <div className="w-44 h-44 mx-auto mb-3 rounded-xl overflow-hidden border-2 border-green-200 shadow-sm">
                          <img src="/pay-wechat-qr.png" alt="微信收款码" className="w-full h-full object-contain"
                      ...
                      <>
                        <div className="w-44 h-44 mx-auto mb-3 rounded-xl overflow-hidden border-2 border-blue-200 shadow-sm">
                          <img src="/pay-alipay-qr.png" alt="支付宝收款码" className="w-full h-full object-contain"
                            onError={(e) => { const t = e.currentTarget; t.style.display = "none"; t.parentElement!.classList.add("bg-blue-50", "flex", "items-center", "justify-center"); t.parentElement!.innerHTML = '<p class=\"text-xs text-blue-600 text-center px-3\">📷<br/>请上传支付宝收款码<br/>pay-alipay-qr.png</p>'; }} />
                        </div>
