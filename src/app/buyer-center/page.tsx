...
import { ShoppingBag, Users, CheckCircle2, Loader2 } from "lucide-react";
...
export default function BuyerCenterPage() {
  ...
  const [selectedPkg, setSelectedPkg] = useState<BuyerPackage | null>(null);
  ...
  const handlePurchase = (pkg: BuyerPackage, type: "individual" | "group") => {
    setSelectedPkg(pkg);
    setShowPaywall(true);
  };
