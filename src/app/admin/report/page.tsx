  ...
  const generateReport = async () => {
    ...
    try {
      const res = await fetch("/api/generate-report", {
        ...
        body: JSON.stringify({ storeId, season }),
      });
      ...
      a.download = `商品企划报告_${storeName}_${season}.docx`;
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">一键生成完整的 Word 格式商品企划报告，可直接打印或发送给团队</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-3">
              {SEASONS.map(s => (
                <button key={s.value} onClick={() => setSeason(s.value)} className={`px-5 py-2.5 rounded-xl text-sm font-semibold border transition-colors ${
                  season === s.value
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="space-y-3">
            {[
              ...
              { label: "上货波段计划", ok: stats.waves > 0, desc: stats.waves > 0 ? `已设置 ${stats.waves} 个波段` : "请在商品企划页面先设置" },
        ...
        >
          ...
          {loading ? "正在生成报告，请稍候..." : "生成并下载 Word 报告"}
        </button>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-2xl p-5">
          ...
          <ul className="text-xs text-blue-700 space-y-1">
            ...
            <li>✅ 包含所有已录入数据：客户分析、商品规划、波段计划、选品评估、库存、采购</li>
            <li>✅ 色彩使用专业十二季型术语，风格使用八大风格/五大风格专业术语</li>
