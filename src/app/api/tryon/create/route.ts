...
const PACKAGES: Record<string, { name: string; price: number; unit: string; type: string; days?: number; tries?: number }> = {
  tryon_first_1yuan: { name: "首单体验", price: 1, unit: "次", type: "first", tries: 1 },
  tryon_monthly_99: { name: "包月畅试", price: 99, unit: "月", type: "month", days: 30 },
  tryon_quarter_199: { name: "季卡", price: 199, unit: "季", type: "quarter", days: 90 },
  tryon_year_699: { name: "年卡", price: 699, unit: "年", type: "year", days: 365 },
};
