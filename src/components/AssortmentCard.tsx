...
export default function AssortmentCard({ block, fallbackImages = [] }: AssortmentBlockProps) {
      ...
      >
        <div className="aspect-[16/9] md:aspect-[2.5/1] relative bg-gradient-to-br from-[#6b3f70] via-[#a86fa0] to-[#d9a7c7]">
          {safeImage ? (
            ...
            <ProductCollage images={fallbackImages} gradient="bg-gradient-to-br from-[#6b3f70] via-[#a86fa0] to-[#d9a7c7]" />
          )}
