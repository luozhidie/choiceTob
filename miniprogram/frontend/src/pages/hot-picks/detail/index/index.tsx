  ...
  return (
    <View className="detail-page">
        ...
        <View className="detail-image-section">
          ...
          {locked && (
            <View className="detail-lock-overlay">
              ...
              <View className="detail-lock-btn" onClick={() => Taro.navigateTo({ url: '/pages/vip/index' })}>
                <Text className="detail-lock-btn-text">立即开通</Text>
              </View>
            </View>
          )}
        </View>
      ...
      <View className="detail-bottom-bar">
        ...
        <View className="bottom-action-contact" onClick={() => Taro.navigateTo({ url: '/pages/vip/index' })}>
          <Text className="bottom-action-icon">💬</Text>
          <Text className="bottom-action-label">开通会员</Text>
        </View>
