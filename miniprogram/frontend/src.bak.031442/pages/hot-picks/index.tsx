...
const cooperationModes = [
  { level: 'L1', name: '原创设计图稿', price: '¥550-880/件', desc: '纯设计图，适合有板房/工厂配合打板的客户', features: ['原创设计图稿（含款式图+工艺说明+面料建议）', '1轮修改', '源文件交付'], suitable: '有自设板房或有工厂配合打板、车板的客户，比较节省成本', badgeColor: '#1a56db' },
        ...
        <View>
          ...
          {!isMember && (
            <View className="member-banner">
              ...
              <View className="banner-btn" onClick={goToContact}>
                <Text className="banner-btn-text">联系客服</Text>
              </View>
            </View>
          )}
