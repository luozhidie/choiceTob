import { DEFAULT_COMPONENTS, EMPTY_OBJ, Events, PLATFORM_TYPE, TT_SPECIFIC_COMPONENTS, controlledComponent, ensure, getComponentsAlias, hooks, init_dist, internalComponents, isArray, isEnableTTDom, isFunction, isNull, isNumber, isObject, isString, isUndefined, noop, toCamelCase, toDashed, warn } from "./chunk-HLCAIFMI.js";
    ...
    document2.createElement = function(type, ...args) {
        if (type === "root") {
            ...
            if (false) {
                ...
                el.addEventListener = function(type2, listener) {
                    if (type2 === "click") {
                        type2 = "tap";
                    }
                    const bindEventName = type2.startsWith("bind") || type2.startsWith("catch") ? type2 : `bind${type2}`;
                    const wrapper = (event)=>{
                    ...
                    if (!el.__eventWrappers) {
                        el.__eventWrappers = /* @__PURE__ */ new WeakMap();
                    }
                    el.__eventWrappers.set(listener, wrapper);
                    ttEventListener(bindEventName, wrapper);
                };
                el.removeEventListener = function(type2, listener) {
                    var _a3;
                    if (type2 === "click") {
                        type2 = "tap";
                    }
                    const bindEventName = type2.startsWith("bind") || type2.startsWith("catch") ? type2 : `bind${type2}`;
                    const wrapper = (_a3 = el.__eventWrappers) === null || _a3 === void 0 ? void 0 : _a3.get(listener);
                    if (wrapper) {
...
var init_document2 = __esm({
    "../../node_modules/.pnpm/@tarojs+runtime@4.2.0/node_modules/@tarojs/runtime/dist/bom/document.js" () {
        ...
        init_document();
        init_env();
        taroDocumentProvider = false ? env.document : env.document = isEnableTTDom() ? createTTDomDocument() : createDocument();
    }
});
