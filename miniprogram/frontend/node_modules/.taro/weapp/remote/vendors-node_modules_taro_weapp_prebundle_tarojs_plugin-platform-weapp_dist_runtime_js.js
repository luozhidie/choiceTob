...
// ../../node_modules/.pnpm/@tarojs+plugin-platform-weapp@4.2.0_@tarojs+service@4.2.0_@swc+helpers@0.5.15__@tarojs+shared@4.2.0/node_modules/@tarojs/plugin-platform-weapp/dist/runtime.js
...
function initNativeApi(taro) {
    (0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_0__.processApis)(taro, wx, {
        needPromiseApis,
        modifyApis (apis) {
...
var hostConfig = {
    ...
    transferHydrateData (data, element, componentsAlias) {
        ...
        if (element.isTransferElement) {
            ...
            page.setData({
                [(0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(data.nn)]: data
            });
            return {
                sid: element.sid,
                ["v"]: "",
...
(0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_0__.mergeReconciler)(hostConfig);
(0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_0__.mergeInternalComponents)(components);
