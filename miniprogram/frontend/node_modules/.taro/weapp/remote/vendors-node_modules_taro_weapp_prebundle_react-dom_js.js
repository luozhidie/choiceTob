...
/* harmony export */ });
/* harmony import */ var _chunk_GNBE3VWC_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-GNBE3VWC.js */ "./node_modules/.taro/weapp/prebundle/chunk-GNBE3VWC.js");
/* harmony import */ var _chunk_OJNP6RHK_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-OJNP6RHK.js */ "./node_modules/.taro/weapp/prebundle/chunk-OJNP6RHK.js");
/* harmony import */ var _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-HLCAIFMI.js */ "./node_modules/.taro/weapp/prebundle/chunk-HLCAIFMI.js");
...
/* provided dependency */ var navigator = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-OJNP6RHK.js */ "./node_modules/.taro/weapp/prebundle/chunk-OJNP6RHK.js")["nav"];
...
var require_react_reconciler_production_min = (0,_chunk_QRPWKJ4C_js__WEBPACK_IMPORTED_MODULE_3__.__commonJS)({
    "../../node_modules/.pnpm/react-reconciler@0.29.0_react@18.3.1/node_modules/react-reconciler/cjs/react-reconciler.production.min.js" (exports, module) {
        module.exports = function $$$reconciler($$$hostConfig) {
            var exports2 = {};
            "use strict";
            var aa = (0,_chunk_GNBE3VWC_js__WEBPACK_IMPORTED_MODULE_0__.require_react)(), ba = require_scheduler(), ca = Object.assign;
            function m(a) {
...
// ../../node_modules/.pnpm/@tarojs+react@4.2.0_react@18.3.1/node_modules/@tarojs/react/dist/react.esm.js
(0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.init_dist)();
(0,_chunk_OJNP6RHK_js__WEBPACK_IMPORTED_MODULE_1__.init_dist)();
...
function updatePropsByPayload(dom, oldProps, updatePayload) {
    ...
    for(let i = 0; i < updatePayload.length; i += 2){
        ...
        if ("mini" === _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY) {
            if (key === "__fixed") {
...
function getUpdatePayload(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_OJNP6RHK_js__WEBPACK_IMPORTED_MODULE_1__.FormElement;
    for(i in newProps){
        if (oldProps[i] !== newProps[i] || isFormElement && i === "value") {
            if (i === "style" && (0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(oldProps[i]) && (0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(newProps[i]) && isEqual(oldProps[i], newProps[i])) continue;
...
function setEvent(dom, name, value, oldValue) {
    ...
    const compName = (0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.capitalize)((0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.toCamelCase)(dom.tagName.toLowerCase()));
    if (eventName === "click" && "mini" !== _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY && compName in _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.internalComponents) {
        eventName = "tap";
    }
    if (false) {}
    if ((0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (oldValue) {
            dom.removeEventListener(eventName, oldValue, "mini" !== _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY ? false : void 0);
            dom.addEventListener(eventName, value, "mini" !== _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY ? {
                isCapture,
                sideEffect: false
            } : void 0);
        } else {
            dom.addEventListener(eventName, value, "mini" !== _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY ? isCapture : void 0);
        }
    } else {
...
function setStyle(style, key, value) {
    if (key[0] === "-" && "mini" !== _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY) {
        style.setProperty(key, value.toString());
        return;
    }
    style[key] = (0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isNumber)(value) && IS_NON_DIMENSIONAL.test(key) === false ? "mini" === _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY ? value + "px" : (0,_chunk_OJNP6RHK_js__WEBPACK_IMPORTED_MODULE_1__.convertNumber2PX)(value) : value === null ? "" : value;
}
function setHarmonyStyle(dom, value, oldValue) {
    const style = dom._st.hmStyle;
    if ((0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(oldValue)) {
    ...
    if ((0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(value)) {
...
function setProperty(dom, name, value, oldValue) {
    ...
    if (name === "key" || name === "children" || name === "ref") ;
        ...
        if (false) {} else {
            ...
            if ((0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isString)(value)) {
                style.cssText = value;
            } else {
                if ((0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isString)(oldValue)) {
                    style.cssText = "";
                    oldValue = null;
                }
                if ((0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(oldValue)) {
                    for(const i in oldValue){
                        if (!(value && i in value)) {
                            if ("mini" === _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY && i === "position" && oldValue[i] === "fixed") {
                                dom.setLayer(0);
                            }
                            setStyle(style, i, "");
                        }
                ...
                if ((0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(value)) {
                    for(const i in value){
                        if (!oldValue || !isEqual(value[i], oldValue[i])) {
                            if ("mini" === _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.PLATFORM_TYPE.HARMONY && i === "position") {
                                if (value[i] === "fixed" || value[i] !== "fixed" && (oldValue === null || oldValue === void 0 ? void 0 : oldValue[i])) {
                                    dom.setLayer(value[i] === "fixed" ? 1 : 0);
                                }
                            }
    ...
    } else if (!(0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (false) {}
        if (value == null) {
...
var hostConfig = {
    ...
    resetAfterCommit: _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    createInstance (type, props, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const element = _chunk_OJNP6RHK_js__WEBPACK_IMPORTED_MODULE_1__.taroDocumentProvider.createElement(type);
    ...
    finalizeInitialChildren (dom, type, props) {
        let newProps = props;
        if (dom instanceof _chunk_OJNP6RHK_js__WEBPACK_IMPORTED_MODULE_1__.FormElement) {
    ...
    createTextInstance (text, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const textNode = _chunk_OJNP6RHK_js__WEBPACK_IMPORTED_MODULE_1__.taroDocumentProvider.createTextNode(text);
    ...
    beforeActiveInstanceBlur: _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    afterActiveInstanceBlur: _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    preparePortalMount: _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    prepareScopeUpdate: _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    getInstanceFromScope: ()=>null,
    getCurrentEventPriority () {
        return import_constants.DefaultEventPriority;
    },
    detachDeletedInstance: _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    // -------------------
    //      Microtasks
    //     (optional)
    // -------------------
    supportsMicrotasks: true,
    scheduleMicrotask: (0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isUndefined)(Promise) ? setTimeout : (callback)=>Promise.resolve(null).then(callback).catch(function(error) {
            setTimeout(()=>{
                throw error;
            });
        }),
    ...
    commitMount: _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    ...
    resetTextContent: _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    ...
    unhideInstance (instance, props) {
        ...
        display = display == null || (0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isBoolean)(display) || display === "" ? "" : ("" + display).trim();
...
function createRoot(domContainer, options = {}) {
    ...
    _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("dispatchTaroEvent", (e, node)=>{
        const eventPriority = getEventPriority(e.type);
        TaroReconciler.runWithPriority(eventPriority, ()=>{
            node.dispatchEvent(e);
        });
    });
    _chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("modifyTaroEvent", (e, node)=>{
        var _a2, _b;
...
function unmountComponentAtNode(dom) {
    (0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.ensure)(dom && [
        1,
        8,
        9,
        11
...
var portalType = (0,_chunk_HLCAIFMI_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(Symbol) && Symbol.for ? Symbol.for("react.portal") : 60106;
